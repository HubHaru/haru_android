...
public class ActionsLayout extends FrameLayout {
    ...
    private static final String TAG = ActionsLayout.class.getSimpleName();
...
//        Log.e(TAG, String.format("called onTouchEvent() : %s, %s", event.getX(), event.getY()));
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (alpha != 1f)
            canvas.saveLayerAlpha(0, 0, canvas.getWidth(), canvas.getHeight(), (int) (255 * alpha),
