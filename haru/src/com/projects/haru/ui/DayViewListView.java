...
public class DayViewListView extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        mListView =
                (ParallaxListView) mLayout.findViewById(R.id.day_view_listview_listview);
    ...
    private class HelloAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ActionsContentView a = (ActionsContentView) convertView
                    .findViewById(R.id.actionsContentView);
            ContentLayout mLayout = (ContentLayout) a.getContentContainer();
